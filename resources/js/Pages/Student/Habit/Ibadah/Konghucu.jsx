        ...
        <StudentLayout user={user}>
            ...
            <div className="min-h-screen bg-gradient-to-br from-rose-600 via-red-700 to-red-900 relative overflow-hidden">
                ...
                <div className="absolute top-0 left-0 w-full h-full pointer-events-none opacity-20">
                    ...
                    >
                        <Sunrise size={100} strokeWidth={1} />
                    </motion.div>
                </div>
                ...
                <div className="max-w-xl mx-auto px-6 pb-24 relative z-10">
                            ...
                            return (
                                <motion.div
                                    ...
                                    className={`relative group cursor-pointer rounded-[2rem] p-5 border-2 transition-all duration-300 ${status.completed
                                            ? 'bg-white border-rose-500 shadow-[0_0_20px_rgba(225,29,72,0.3)]'
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-5">
                                            ...
                                            <div className={`w-14 h-14 rounded-2xl flex items-center justify-center transition-all duration-500 shadow-inner ${status.completed
                                                    ? 'bg-rose-100 text-rose-600 rotate-[360deg]'
                                            ...
                                            {/* Details */}
                                            <div>
                                                <h3 className={`font-black text-lg ${status.completed ? 'text-rose-700' : 'text-gray-800'}`}>
                                                    {activity.name}
                                                </h3>
                                        ...
                                        <div className={`w-10 h-10 rounded-full flex items-center justify-center border-2 transition-all duration-500 ${status.completed
                                                ? 'bg-rose-600 border-rose-600 text-white scale-110 shadow-lg shadow-rose-200'
                    ...
                    >
                        <p className="text-[10px] text-rose-200/50 font-black uppercase tracking-widest">
                            Xian You Yi De, Yi De Ri Xin
                        </p>
                    </motion.div>
                </div>
            </div>
                            ...
                            <div className="p-8">
                                <div className="space-y-6">
                                    <p className="text-gray-600 font-medium text-center">
                                        Apakah kamu sudah menjalankan **{selectedTask.name}** dengan sepenuh hati?
                                    </p>
                                    ...
                                    >
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-rose-500 font-bold">Dapatkan +{selectedTask.xp} XP</p>
                                            </div>
                                        </div>
